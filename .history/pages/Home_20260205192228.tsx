  ...
  return (
    <div className="bg-[#fcfcfc] overflow-x-hidden">
      ...
      <Helmet>
        ...
        {/* Structured Data with updated coordinates */}
      ...
      {/* Map/Location Section - Updated with new coordinates */}
      <section className="py-24 md:py-40 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            >
              ...
              {/* Get Directions Button - Updated with new coordinates */}
              <div className="mt-8">
                <a
                  href="https://www.google.com/maps/dir/?api=1&destination=24.17800614105382,85.87714331640271"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-3 bg-[#0a1128] text-white px-8 py-4 rounded-xl font-bold hover:bg-[#c5a059] transition-colors shadow-lg"
                >
                  <Navigation size={20} />
            ...
            <motion.div 
              className="h-[400px] md:h-[500px] lg:h-[600px] rounded-3xl overflow-hidden border border-slate-100 shadow-2xl relative"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
