  ...
  return (
    <div className="bg-[#fcfcfc] overflow-x-hidden">
            ...
            >
              <div className="space-y-6 md:space-y-10">
                <div className="flex items-center justify-center lg:justify-start space-x-4">
                  ...
                  <span className="text-[#c5a059] font-bold text-[10px] md:text-xs uppercase tracking-[0.4em]">Established Chambers</span>
                </div>
                
                <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-serif text-[#0a1128] leading-[1.1] tracking-tight">
                  Defending Your <br className="hidden md:block"/>
                  <span className="italic font-normal">Rights</span> with <br className="hidden md:block"/>
                ...
                <p className="text-base md:text-xl text-slate-500 max-w-xl mx-auto lg:mx-0 leading-relaxed font-light px-4 lg:px-0">
                  A boutique legal practice specializing in high-stakes litigation, corporate advisory, and constitutional defense across India.
                </p>
            ...
            >
              <div className="relative mx-auto max-w-[280px] sm:max-w-md lg:max-w-none p-4 md:p-8 bg-white shadow-2xl rounded-sm border border-slate-100">
                ...
                <div className="mt-6 text-center lg:text-left">
                  <h4 className="text-xl md:text-2xl font-serif font-bold text-[#0a1128]">Julian Vance</h4>
                  <p className="text-[#c5a059] font-bold text-[9px] md:text-[10px] uppercase tracking-[0.2em] mt-1">Advocate, High Court of India</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="bg-[#0a1128] py-16 md:py-24 text-white border-y border-[#c5a059]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 lg:divide-x divide-white/10">
            {[
              { label: 'Years of Practice', val: '18+' },
              { label: 'Cases Argued', val: '1200+' },
              { label: 'Courts covered', val: '14' },
      ...
      <section className="py-24 md:py-40 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-32">
            <motion.span {...fadeInUp} className="text-[#c5a059] font-bold text-xs uppercase tracking-[0.4em] mb-4 block">Practice Verticals</motion.span>
            <motion.h2 {...fadeInUp} className="text-3xl md:text-6xl font-serif text-[#0a1128]">Areas of Specialization</motion.h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-0 border lg:border-slate-100 rounded-2xl lg:rounded-none overflow-hidden bg-slate-50 lg:bg-transparent">
            {PRACTICE_AREAS.map((area, i) => (
              ...
              >
                ...
                <Link 
                  to="/practice-areas" 
                  className="inline-flex items-center gap-3 text-[#c5a059] text-[10px] md:text-xs font-bold uppercase tracking-widest hover:gap-5 transition-all mt-auto"
                >
      ...
      <section className="py-24 md:py-40 bg-[#fcfcfc] border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-32">
            <motion.span {...fadeInUp} className="text-[#c5a059] font-bold text-xs uppercase tracking-[0.4em] mb-4 block">Our Commitment</motion.span>
            <motion.h2 {...fadeInUp} className="text-3xl md:text-6xl font-serif text-[#0a1128]">Why Clients Entrust Us</motion.h2>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-20">
            {[
              { title: 'BCI Registered', desc: 'Practicing with verified credentials and over 18 years of professional standing.', icon: <UserCheck className="w-8 h-8 md:w-10 md:h-10" /> },
              { title: 'Transparent Fees', desc: 'Clear evaluation of legal merits and straightforward fee structures.', icon: <Eye className="w-8 h-8 md:w-10 md:h-10" /> },
              { title: 'Absolute Privacy', desc: 'Strict adherence to advocate-client privilege for all sensitive documentation.', icon: <ShieldCheck className="w-8 h-8 md:w-10 md:h-10" /> },
              { title: 'Fast Updates', desc: 'Dedicated case tracking with prompt updates on court orders and filings.', icon: <Zap className="w-8 h-8 md:w-10 md:h-10" /> },
              { title: 'Elite Drafting', desc: 'Meticulous legal drafting and thorough verification of commercial titles.', icon: <Scale className="w-8 h-8 md:w-10 md:h-10" /> },
              { title: 'Court Presence', desc: 'Experienced oral advocacy before various judicial and quasi-judicial forums.', icon: <Gavel className="w-8 h-8 md:w-10 md:h-10" /> }
            ].map((item, i) => (
      ...
      <section className="py-24 md:py-40 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 md:mb-32">
            <motion.span {...fadeInUp} className="text-[#c5a059] font-bold text-xs uppercase tracking-[0.4em] mb-4 block">Client Feedback</motion.span>
            <motion.h2 {...fadeInUp} className="text-3xl md:text-6xl font-serif text-[#0a1128]">Testimonials</motion.h2>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            <motion.div {...fadeInUp} className="text-center lg:text-left">
              <h2 className="text-3xl md:text-5xl font-serif text-[#0a1128] mb-6">Visit Our Chambers</h2>
              <p className="text-slate-500 mb-10 leading-relaxed font-light text-base md:text-lg">
                Located near the High Court, our offices offer a quiet and secure environment for confidential legal discussions.
              </p>
              ...
              <div className="space-y-6 inline-block text-left">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[9px] text-[#c5a059] font-bold uppercase tracking-widest">Office Address</div>
                    <p className="text-slate-800 font-bold text-sm md:text-base">Chambers 402, High Court Block, New Delhi 110001</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} className="h-[300px] md:h-[450px] lg:h-[500px] rounded-3xl overflow-hidden border border-slate-100 shadow-2xl relative">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.218320496102!2d77.2344!3d28.6139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd17c9b32971%3A0x6a0808a9062a4b8b!2sSupreme%20Court%20of%20India!5e0!3m2!1sen!2sin!4v1708684534832!5m2!1sen!2sin" 
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <motion.div {...fadeInUp} className="border-2 border-slate-100 p-8 md:p-24 lg:p-32 rounded-[2rem] relative bg-white group shadow-2xl shadow-slate-200/50">
            ...
            <p className="text-slate-500 text-base md:text-2xl mb-12 font-light max-w-2xl mx-auto leading-relaxed">
              Schedule an appointment to discuss your case strategy with Advocate Julian Vance. Absolute confidentiality is guaranteed.
            </p>
            <Link 
              to="/consultation" 
            ...
            >
              Book My Case Review <ArrowRight size={20} />
            </Link>
          </motion.div>
        </div>
      </section>
