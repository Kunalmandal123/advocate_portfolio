...
const REAL_BLOG_POSTS = [
  ...
  },
  {
    ...
    fullContent: `
      <div class="space-y-6">
        ...
        <h3 class="text-xl font-serif text-[#0a1128] mb-3">Key Factors Considered by Hazaribagh Sessions Court</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="bg-blue-50 p-4 rounded-lg">
          <h4 class="font-bold text-blue-800 mb-2">Typical Bail Conditions in Hazaribagh Court:</h4>
          <ul class="text-blue-700 text-sm space-y-1">
    ...
    author: "Adv. Vikas Kumar",
    tags: ["Bail", "Sessions Court", "Criminal Procedure", "Hazaribagh"]
  },
  {
    id: 7,
  ...
  },
  {
    ...
    fullContent: `
      <div class="space-y-6">
        <h2 class="text-2xl font-serif text-[#0a1128] mb-4">Motor Accident Claims Tribunal in Hazaribagh</h2>
        <p class="text-slate-600">The Motor Accident Claims Tribunal (MACT) in Hazaribagh adjudicates claims arising from road accidents under the Motor Vehicles Act, 1988. The tribunal provides compensation for death, injury, or property damage caused by motor vehicles.</p>
        ...
        <div class="bg-green-50 p-4 rounded-lg border border-green-100">
          <h4 class="font-bold text-green-800 mb-2">Recent Compensation Awards in Hazaribagh MACT:</h4>
