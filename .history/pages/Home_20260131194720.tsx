    ...
    <div className="bg-[#fcfcfc] overflow-x-hidden">
      ...
      <section className="py-24 md:py-40 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-0 border lg:border-slate-100 rounded-2xl lg:rounded-none overflow-hidden bg-slate-50 lg:bg-transparent"
            initial="hidden"
            whileInView="visible"
      ...
      <section className="py-24 md:py-40 bg-[#fcfcfc] border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div 
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-20"
            initial="hidden"
            whileInView="visible"
            variants={containerVariants}
            viewport={{ once: true }}
