...
// Simple fadeInUp animation without complex typing
const fadeInUp = {
  ...
  return (
    <div className="bg-[#fcfcfc] overflow-x-hidden">
      ...
      <Helmet>
        ...
        {/* Structured Data - Updated with exact location */}
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": 24.17992236981923,
              "longitude": 85.87704876853853
            },
      ...
      {/* Map/Location Section - Updated with exact location */}
      <section className="py-24 md:py-40 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <motion.div 
              className="h-[300px] md:h-[450px] lg:h-[500px] rounded-3xl overflow-hidden border border-slate-100 shadow-2xl relative"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
            >
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3627.625693912834!2d85.87704876853853!3d24.17992236981923!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjTCsDEwJzQ3LjciTiA4NcKwNTInMzc.0Ik!5e0!3m2!1sen!2sin!4v1730000000000!5m2!1sen!2sin"
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                ...
                title="Advocate Vikas Kumar Office Location - 24, Suriya Rd, Suriya, Mandramo, Giridih, Jharkhand 825320"
              />
            </motion.div>
          </div>
        </div>
