  ...
  return (
    <div className="bg-[#fcfcfc] overflow-x-hidden">
      ...
      <Helmet>
        ...
        <meta name="description" content="Top-rated Advocate Vikas Kumar (B.A.LL.B, LL.M) practicing at Civil Court Giridih, Hazaribagh & SDM Court Bagodar-Sariya. Expert in Civil, Criminal, Family Law, Property Matters with 5+ years experience." />
