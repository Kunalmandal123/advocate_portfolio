...
const Home: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'My civil case was stuck for 2 years. Advocate Vikas took it in Civil Court Hazaribagh and resolved it within 6 months. Truly professional.',
      rating: 5,
      location: 'Hazaribagh',
      area: 'Civil Law',
      year: '2024'
  ...
  const stats = [
    { label: 'Years of Legal Practice', val: '10+' },
    { label: 'Cases Handled Successfully', val: '1200+' },
    { label: 'Courts Covered in Jharkhand', val: '4+' },
