...
// Fixed fadeInUp animation with proper TypeScript typing
const fadeInUp: HTMLMotionProps<"div"> & { children?: React.ReactNode } = {
...
// Extend Testimonial interface for local use
interface ExtendedTestimonial extends Testimonial {
  location?: string;
}

// Extend PracticeArea interface for local use
interface ExtendedPracticeArea extends PracticeArea {
  availableAt?: string;
}

// Create local testimonials with location
const localTestimonials: ExtendedTestimonial[] = [
  {
    id: '1',
...
// Create local practice areas with availableAt
const localPracticeAreas: ExtendedPracticeArea[] = [
  {
    id: 'civil-law',
