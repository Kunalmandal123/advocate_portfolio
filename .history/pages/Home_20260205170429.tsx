...
const Home: React.FC = () => {
 ...
 const practiceAreas = [
  ...
  },
  {
    ...
    description: 'Professional representation in writ petitions, appeals, bail matters, and constitutional cases before the High Court.',
    icon: 'Landmark',
    availableAt: 'High Court Ranchi'
  }
];
