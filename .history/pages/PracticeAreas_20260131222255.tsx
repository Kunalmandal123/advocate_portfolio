...
const PracticeAreas: React.FC = () => {
  ...
  const stats = [
    { value: "18+", label: "Years Experience", icon: <Briefcase className="w-4 h-4" /> },
    { value: "500+", label: "Cases Handled", icon: <FileText className="w-4 h-4" /> },
    { value: "95%", label: "Success Rate", icon: <CheckCircle2 className="w-4 h-4" /> },
