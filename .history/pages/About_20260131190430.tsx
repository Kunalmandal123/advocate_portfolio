...
import { Award, GraduationCap, MapPin, Briefcase, History, HeartHandshake, BookOpen, Scale, Users, Globe } from 'lucide-react';
  ...
  return (
    <div className="bg-white">
      ...
      <head>
        ...
        <meta name="description" content="Learn about Advocate Vikas Kumar - B.A.LL.B, LL.M qualified lawyer with 18+ years experience practicing at Civil Court Giridih, Civil Court Hazaribagh, SDM Court Bagodar-Sariya. Specialist in Civil, Criminal, Family & Property Law." />
        <meta name="keywords" content="about advocate vikas kumar, lawyer in giridih experience, civil court hazaribagh advocate, sdm court bagodar lawyer, legal education, bar council registration, best advocate jharkhand" />
      </head>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-blue-200 font-medium mb-8">
                B.A.LL.B, LL.M | Practicing at Civil Court Giridih, Hazaribagh & SDM Court Bagodar-Sariya
              </p>
            ...
            <div className="hidden md:block">
              <div className="aspect-square bg-slate-800 rounded-3xl overflow-hidden shadow-2xl rotate-3 border-4 border-[#c5a059]/20">
                <img 
                  src="/advocate-vikas-kumar-about.jpg" 
                  className="w-full h-full object-cover" 
                  alt="Advocate Vikas Kumar - B.A.LL.B LL.M Lawyer in Giridih Hazaribagh"
              ...
              <div>
                ...
                <div className="prose prose-lg text-slate-600 max-w-none">
                  <p className="mb-4 text-lg">
                    ...
                    completing his B.A.LL.B followed by an LL.M degree. With over <strong>18 years of dedicated practice</strong>, 
            ...
            <div className="space-y-8">
              <div className="bg-[#0a1128] p-8 rounded-[2rem] text-white border border-[#c5a059]/20">
                ...
                <p className="text-slate-300 italic leading-relaxed text-lg">
                  ...
                  with compassion to serve the people of Giridih, Hazaribagh, and surrounding regions."
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-3xl mx-auto text-lg">
              Dedicated to providing accessible legal services to residents of Giridih, Hazaribagh, 
              Bagodar-Sariya, and surrounding areas for over 18 years.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Deep understanding of local laws, customs, and court procedures in Giridih and Hazaribagh districts.",
                icon: <MapPin className="w-8 h-8" />
              },
              {
                title: "Accessible Justice",
                description: "Affordable legal services with flexible consultation hours for working professionals and families.",
                icon: <Users className="w-8 h-8" />
              },
              {
                title: "Trusted Reputation",
                description: "Consistently ranked among the most reliable advocates in the region with a 96% client satisfaction rate.",
...
const Clock: React.FC<{ className?: string, size?: number }> = ({ className, size = 16 }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width={size} 
    height={size} 
