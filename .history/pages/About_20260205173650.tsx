        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-3xl mx-auto text-lg">
              ...
              Bagodar-Sariya, and surrounding areas for over 10 years.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Deep understanding of local laws, customs, and court procedures in Giridih and Hazaribagh districts.",
